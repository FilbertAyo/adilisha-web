<x-app-layout>
                            ...
                            <tbody>
                                @forelse($galleries as $gallery)
                                    <tr>
                                        ...
                                        <td>
                                            @if($gallery->category)
                                                <span class="badge bg-info">{{ $gallery->category->name }}</span>
                                            @else
            ...
            <div class="modal-content">
                ...
                <form id="createGalleryForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="create_category_id" class="form-label">Category (Optional)</label>
    ...
    <script>
        ...
        function editGallery(id) {
            ...
            document.getElementById('edit_category_id').value = gallery.category_id || '';

                    ...
                    <form action="{{ route('admin.blog.update', $blog) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('excerpt') is-invalid @enderror" 
                                      ...
                                      placeholder="A brief summary of the blog post (optional)">{{ old('excerpt', $blog->excerpt) }}</textarea>
                            ...
                            @if($blog->featured_image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $blog->featured_image) }}" 
                                         alt="{{ $blog->title }}" 
                                         style="max-width: 300px; max-height: 200px; object-fit: cover; border-radius: 4px;">
                                </div>
                            @endif
                            <input type="file" class="form-control @error('featured_image') is-invalid @enderror" 
                                   id="featured_image" name="featured_image" accept="image/*">
                            <small class="text-muted">Leave empty to keep current image. Recommended size: 1200x630px. Max size: 2MB</small>
                        ...
                        @php
                            $authorType = old('author_type', $blog->team_id ? 'team' : 'custom');
                        @endphp
                            ...
                            <div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="author_type" id="author_type_team" 
                                           value="team" {{ $authorType == 'team' ? 'checked' : '' }} required>
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="author_type" id="author_type_custom" 
                                           value="custom" {{ $authorType == 'custom' ? 'checked' : '' }}>
                        ...
                        <div id="team_member_section" style="display: {{ $authorType == 'team' ? 'block' : 'none' }};">
                            <div class="mb-3">
                                ...
                                <select class="form-select @error('team_id') is-invalid @enderror" id="team_id" name="team_id">
                                    ...
                                    @foreach($teams as $team)
                                        <option value="{{ $team->id }}" {{ old('team_id', $blog->team_id) == $team->id ? 'selected' : '' }}>
                        ...
                        <div id="custom_author_section" style="display: {{ $authorType == 'custom' ? 'block' : 'none' }};">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('custom_author_name') is-invalid @enderror" 
                                           id="custom_author_name" name="custom_author_name" value="{{ old('custom_author_name', $blog->custom_author_name) }}">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('custom_author_position') is-invalid @enderror" 
                                           ...
                                           value="{{ old('custom_author_position', $blog->custom_author_position) }}" placeholder="e.g., Guest Writer">
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Toggle to publish or unpublish this blog post</small>
                        </div>

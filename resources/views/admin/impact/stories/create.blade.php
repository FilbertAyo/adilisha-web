    ...
    <div class="row">
        <div class="col-md-12 col-xl-10 offset-xl-1">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h5 class="mb-0">Create New Success Story</h5>
                    <p class="text-muted mb-0">Share an inspiring story from our programs</p>
                </div>
                    ...
                    <form action="{{ route('admin.impact.stories.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('category') is-invalid @enderror" id="category" name="category" required>
                                ...
                                <option value="student" {{ old('category') == 'student' ? 'selected' : '' }}>Student Story</option>
                                <option value="teacher" {{ old('category') == 'teacher' ? 'selected' : '' }}>Teacher Story</option>
                                <option value="community" {{ old('category') == 'community' ? 'selected' : '' }}>Community Impact</option>
                            </select>
                            @error('category')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <small class="text-muted">Main image of the person/community. Recommended: Square ratio. Max: 2MB</small>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <small class="text-muted">Optional supporting image</small>
                                @error('image_1')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="d-flex justify-content-end gap-2 mt-4">
                            ...
                            <button type="submit" class="btn btn-primary">Create Success Story</button>
                        </div>
                    </form>
                </div>
            </div>

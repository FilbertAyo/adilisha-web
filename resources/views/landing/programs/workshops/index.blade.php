      ...
      <div class="container">
        <div class="row">
        	<div class="col-md-4 d-flex ftco-animate">
              ...
              <a href="{{ route('workshops.view') }}" class="block-20" style="background-image: url('front-end/images/workshop-1.jpg');">
              </a>
              <div class="text p-4 d-block">
                ...
                <p><a href="{{ route('workshops.view') }}">View Details <i class="ion-ios-arrow-forward"></i></a></p>
              </div>
            </div>
          </div>
          <div class="col-md-4 d-flex ftco-animate">

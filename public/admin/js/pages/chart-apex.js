...
setTimeout(function () {
  (function () {
    ...
    var options_bar_chart_2 = {
      ...
      colors: ['#072649', '#52c41a', '#faad14', '#13c2c2'],
      responsive: [
        {
          breakpoint: 480,
          options: {
    ...
    var options_bar_chart_4 = {
      ...
      colors: ['#072649', '#13c2c2', '#52c41a', '#faad14', '#ff4d4f'],
      stroke: {
        width: 1,
        colors: ['#fff']
      },
    ...
    var options_bubble_chart_1 = {
      ...
      colors: ['#072649', '#52c41a', '#faad14', '#ff4d4f'],
      fill: {
        opacity: 0.8
      },
      xaxis: {
    ...
    var options_scatter_chart_1 = {
      ...
      colors: ['#072649', '#52c41a', '#ff4d4f', '#faad14', '#13c2c2'],
      series: [
        {
          name: 'SAMPLE A',
          data: [
    ...
    var options_pie_chart_1 = {
      ...
      colors: ['#072649', '#52c41a', '#13c2c2', '#faad14', '#ff4d4f'],
      legend: {
        show: true,
        position: 'bottom'
      },
